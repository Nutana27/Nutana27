...
public class EmployeeListPage {
	...
	By deleteMsg = By.xpath("//*[contains(text(),'Successfully Deleted') and @class]");
	...
	public boolean isDeleteMsgDisplayed() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
		return wait.until(ExpectedConditions.visibilityOfElementLocated(deleteMsg)).isDisplayed();
	}
}
